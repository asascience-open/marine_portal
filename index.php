...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="./js/ext-3.4.1/resources/css/ext-all.css"/>
  ...
  <body onload="Ext.onReady(function(){init()})">
    ...
    <script type="text/javascript" src="./js/ext-3.4.1/SearchField.js"></script>
    <script type="text/javascript" src="./js/ext-3.4.1/IndentedTreeNodeUI.js"></script>
